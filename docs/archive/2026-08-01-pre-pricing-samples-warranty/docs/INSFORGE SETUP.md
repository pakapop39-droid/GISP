...
Migration/API/UI ที่มีอยู่ใน Development เป็น Preliminary Baseline ตาม DEC-031 จนกว่า Demo Version 1.3
จะผ่าน Human UAT 8 Scenario และ GISP Admin Sign-off
...
| Demo Modes | `?mode=overview`, `?mode=prototype` |
| Functional State | Local Storage `gisp-demo-prototype-v3` |
...
Functional Prototype ไม่ใช้ Auth, Database, Storage Upload, Email หรือ Transaction API
