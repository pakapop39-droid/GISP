...
**Change Summary:** ล็อก Demo Gate Version 1.3, Core Scope ที่ตกหล่น, Canonical State, Document Number และ Production Role ตาม DEC-030 ถึง DEC-036  
...
4. `CODEX DEVELOPMENT.md` และ `DEVELOPMENT MASTER BLUEPRINT.md`
5. `DATABASE SCHEMA.md`
6. เอกสาร UX/UI Volume 1, Volume 2 และ Volume 3-A ถึง 3-D
...
* Quotation Builder ใส่ชื่อหรือโลโก้ของสมาชิกเป็น Post-MVP
...
* Demo Version 1.3 ที่ Deploy อยู่เป็น Baseline สำหรับ Human UAT 8 Scenario และ Demo Gate ปัจจุบัน
* Full Demo Unified State Version 4 เป็น Demo Enhancement ที่ไม่เป็น Gate ใหม่ เว้นแต่มี Approved Decision ฉบับใหม่
...
* ผู้จัดส่ง  
* ผู้ดูแลการเคลม  
* ผู้ตรวจสอบยอดขายและค่าคอมมิชชัน
...
สมาชิกเห็นเฉพาะราคาสมาชิก ไม่เห็นราคาทุนโรงงานหรือกำไรของบริษัท
...
* เก็บ Order/Supplier Snapshot ให้พร้อมต่อยอด Commission ใน Post-MVP โดยไม่สร้าง Commission Workflow ใน Core
...
Production Role Catalog ใช้ Code ตามหัวข้อ 0.8 ผู้ใช้หนึ่งคนถือได้หลาย Role
และ `GISP Admin` ไม่มีใน Production เพราะเป็นชื่อรวมเพื่อสลับบทบาทใน Demo เท่านั้น

* `MEMBER_ADMIN` ดูแลการอนุมัติ ระงับ และสิทธิ์สมาชิก
...
* Factory Cost  
* Member Price  
* Suggested Retail Price ในอนาคต  
* Currency  
* Effective Date  
* Expiry Date ถ้ามี  
* Price Status  
...
* ตัวอย่างวัสดุสามารถระบุสถานะว่ามีที่ Built-in Studio หรือไม่

## **10.2 ข้อมูลตัวอย่างโชว์รูม**

* Sample Code  
* Option Code  
* Product หรือ Material ที่เกี่ยวข้อง  
* สถานที่จัดแสดง  
* Shelf Location  
...
ฟังก์ชันบริหารการยืมตัวอย่างเต็มรูปแบบเป็น Future Feature แต่ควรวางโครงสร้างรองรับไว้
...
LINE และ SMS เป็น Future Feature
...
> **ขอบเขต Reconciled:** Core MVP แสดง Executive Summary แบบอ่านอย่างเดียวและ KPI พื้นฐานจาก Order, Payment, Delay, Delivery และ Claim เท่านั้น รายการ Commission, Advanced BI และการวิเคราะห์เชิงลึกทั้งหมดในหัวข้อนี้เป็น Post-MVP
...
* Active Dealers  
* Orders per Dealer  
* Conversion จาก Project Item เป็น Order  
* Production Delay Rate  
* Claim Rate  
* On-time Delivery Rate

## **26.2 รายงานค่าคอมมิชชันโรงงาน (Post-MVP)**

ส่วนนี้เก็บไว้เป็นเอกสารอ้างอิงสำหรับ Post-MVP เท่านั้น ห้ามสร้าง Table, API, UI, KPI หรือ Workflow Commission ใน Core MVP
...
## **27.2 AI Catalog Import (Post-MVP)**

AI อ่าน PDF และสร้าง Product Draft เป็น Post-MVP ห้ามพัฒนาเป็นงานคู่ขนานระหว่าง Core MVP

ระบบหลักควรรองรับการรับข้อมูลที่ผ่านการตรวจจาก AI ในอนาคต
...
* Duplicate Project  
* Saved Address  
* Share Product Schedule Link  
* Product Option Sample Location  
...
* โรงงาน Login  
* Supplier Portal  
* Marketplace เปิดทั่วไป  
* ระบบ Stock  
* Payment Gateway  
* QR Payment  
* ตรวจสลิปอัตโนมัติ  
* Quotation Builder ใส่โลโก้สมาชิก  
* White-label Dealer Portal  
* Commission ทุกประเภท  
* Subscription  
* Smart BOQ Integration  
* Material Library Integration  
* AI Catalog Import เต็มรูปแบบ  
* AI Search by Image  
* AI Product Recommendation  
* AI Quotation Assistant  
* Real-time Shipping API  
* ERP Integration  
* Accounting Integration  
* Warehouse Management  
* Sample Borrowing System  
...
Outstanding Commission เป็น KPI Post-MVP และไม่อยู่ใน Finance KPI ของ Core
...
# **37\. Acceptance Criteria ระดับธุรกิจ**
...
พัฒนาแบบ Workflow Vertical Slice โดยแต่ละลำดับต้องมีฐานข้อมูล, API/Action, หลังบ้าน, หน้าสมาชิกที่เกี่ยวข้อง, เอกสาร, Notification, Permission/RLS Test และ UAT ครบก่อนเริ่มลำดับถัดไป

1. Login, บริษัท, ผู้ใช้ และสิทธิ์
2. Product และ Supplier Master
3. Project และรายการสินค้า
4. Custom Request for Quotation
5. Custom Quotation
6. Order และ Payment
7. Production และ QC
8. Shipment และ Delivery
9. Claim
10. Dashboard และ Report ขั้นพื้นฐาน

รายละเอียด Done Criteria ของแต่ละลำดับอยู่ใน `MVP IMPLEMENTATION PLAN.md` ส่วน AI Catalog Import และ Commission อยู่ใน Post-MVP Backlog เท่านั้น

---

# **39\. หลักการออกแบบระบบ**

1. Project First  
2. Member sees Member Price only  
