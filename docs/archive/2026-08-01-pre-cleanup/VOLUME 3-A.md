...
**Change Summary:** ล็อก Excel/CSV Import เป็น Core และระบุ AI Catalog ทุกส่วนเป็น Post-MVP Reference ตาม DEC-032/DEC-036  
**Document Type:** UX/UI Flow and Back-office Screen Specification  
**Project Stage:** Core MVP + Post-MVP Reference  
...
5. GISP – Codex Development Specification
...
* AI Catalog Import, Commission Configuration และ Product Automation ขั้นสูงเป็น Post-MVP
...
* AI Catalog Import Review (Post-MVP Reference)  
* Catalog QA  
...
## **2.2 Post-MVP Reference — AI Catalog Import**
...
5. ตรวจข้อมูลจาก PDF และ AI ได้  
...
## **4.5 No Guessing in AI Import (Post-MVP Reference)**
...
/admin/catalog/ai-drafts  
/admin/catalog/ai-drafts/\[draftId\]
...
5. Edit Supplier  
6. Supplier Contacts  
7. Supplier Commercial Terms  
8. Supplier Documents  
9. Supplier Product Summary  
10. Suspend Supplier
...
12. Create Category  
13. Category Tree  
14. Collection Listing  
15. Create Collection  
16. Tag Management  
17. Option Group Listing  
18. Create Option Group  
19. Option Value Management  
20. Sample Location Management

## **Product**

21. Product Listing  
22. Product Quick View  
23. Create Product – Basic Information  
24. Create Product – Classification  
25. Create Product – Specification  
26. Create Product – Variant  
27. Create Product – Options  
28. Create Product – Media  
29. Create Product – Pricing  
30. Create Product – Review  
31. Product Detail  
32. Edit Product  
33. Product Media Manager  
34. Product Document Manager  
35. Product Variant Manager  
36. Product Option Manager  
37. Related Product Manager  
38. Copy Product  
39. Suspend Product  
40. Discontinue Product  
41. Archive Product

## **Pricing**

42. Product Price Overview  
43. Create Factory Cost Version  
44. Create Member Price Version  
45. Price Calculator  
46. Price Approval Queue  
47. Price Approval Detail  
48. Price History  
49. Expiring Price List  
50. Bulk Price Update
...
55. Import Preview  
56. Import Result  
57. Import Error Review  
58. Source Document Listing  
59. Upload PDF Catalog  
60. AI Import Job  
61. AI Product Draft Listing  
62. AI Product Draft Detail  
63. Source Comparison  
64. Duplicate Review  
65. Batch Approval

## **Publish และ QA**

66. Product Readiness Checklist  
67. Submit for Review  
68. Publish Review Queue  
69. Publish Review Detail  
70. Publish Confirmation  
71. Reject and Return  
72. Catalog QA Dashboard  
73. Missing Data Report  
74. Invalid Price Report  
75. Broken Media Report  
76. Duplicate Product Report  
77. Audit History

รวมประมาณ 77 หน้าจอและสถานะหลัก
...
* MOQ Policy  
* Warranty  
Commission Rate/Conditions ไม่แสดงหรือบันทึกใน Core MVP
...
* Display Order  
* Active  
* Default Specification Template ใน Should Have  
* Default Option Groups ใน Should Have
...
# **29\. Create Product Step 1: Basic Information**
...
* Product Code ไม่ซ้ำ  
* Supplier จำเป็น  
* Name Thai จำเป็นสำหรับ Publish  
...
# **31\. Step 3: Specification and Dimensions**
...
## **Variant Generator – Should Have**

สามารถสร้าง Variant จากชุดขนาดหรือ Option Combination

แต่ Admin ต้อง Review ก่อน Save

---

# **33\. Step 5: Product Options**
...
* Required Group ต้องมีอย่างน้อยหนึ่ง Available Value  
...
Standard Product ต้องมี Main Image อย่างน้อยหนึ่งภาพ
...
หากลบ Main Image ต้องเลือกภาพใหม่ก่อน

---

# **41\. Product Document Manager**
...
# **48\. Create Factory Cost Version**
...
# **49\. Create Member Price Version**
...
สามารถ Compare สอง Version ได้ใน Should Have

---

# **54\. Expiring Price List**
...
* Supplier จำเป็น  
* File Size  
* Password-protected PDF ต้องแจ้ง  
* Duplicate File Check ด้วย Checksum

---

# **64\. AI Import Job (Post-MVP Reference)**
...
Admin สามารถ Stop Job ตามนโยบาย

---

# **65\. AI Product Draft Listing (Post-MVP Reference)**
...
# **66\. AI Product Draft Detail (Post-MVP Reference)**

## **Screen ID**

`AICAT-005`

Layout แบบ Split Screen

┌────────────────────────┬─────────────────────────────┐  
│ PDF Source Page        │ Extracted Product Draft     │  
│                        │ Name                        │  
│ Image                  │ SKU                         │  
│ Text                   │ Dimensions                  │  
│                        │ Material                    │  
...
AI ห้ามเติมข้อมูลที่ไม่มีในต้นฉบับ

---

# **67\. Source Comparison**

## **Screen ID**

`AICAT-006`

Admin คลิก Field แล้วระบบ Highlight จุดอ้างอิงใน PDF
...
* ขนาดอยู่ตรงไหน  
* ราคาอยู่ตารางใด  
* ภาพใดเป็น Product หลัก

หากหนึ่งหน้ามีหลายสินค้า ต้องแยก Bounding Region หรือให้ Admin เลือก

---

# **68\. AI Image Matching (Post-MVP Reference)**

ระบบแสดงภาพที่ตรวจพบ
...
หากภาพมีหลายรุ่น ต้อง Flag

> ภาพนี้อาจมีสินค้าหลายรายการ กรุณาตรวจสอบก่อนใช้เป็นภาพหลัก
...
ระบบเปรียบเทียบ Draft กับ Product Existing

Signals

* Same Supplier \+ Factory SKU  
* Similar Name  
* Similar Image  
* Same Dimensions  
* Same Collection
...
การ Ignore ต้องมี Reason

---

# **70\. AI Draft Approval (Post-MVP Reference)**

## **Screen ID**

`AICAT-008`

ก่อน Convert เป็น Product Draft ต้องผ่าน Checklist

* Supplier  
* Product Name  
* SKU หรือเหตุผลไม่มี SKU  
* Category  
* Product Image  
* Dimensions หรือสถานะไม่พบ  
* Material หรือสถานะไม่พบ  
* Source Page  
* Duplicate Review

Actions

* Approve to Product Draft  
* Save for Later  
* Reject Draft  
* Request Supplier Information

Approved Draft ยังไม่ Publish

---

# **71\. Product Readiness Checklist**
...
Review Comments ต้องผูกกับ Section หรือ Field ได้ใน Should Have
...
# **88\. Orderability แยกจาก Sales Status**
...
* Supplier Required  
* Category Required  
* Main Image Required for Publish  
* Name Thai Required  
...
* Required Group ต้องมี Available Value  
* Default ต้อง Active  
...
Autosave เป็น Should Have

---

# **93\. Permission Matrix Part A**
...
## **AI Catalog (Post-MVP Reference)**

GET    /api/admin/source-documents  
POST   /api/admin/source-documents  
POST   /api/admin/source-documents/:id/analyze  
GET    /api/admin/import-jobs/:id  
GET    /api/admin/product-drafts  
GET    /api/admin/product-drafts/:id  
PATCH  /api/admin/product-drafts/:id  
POST   /api/admin/product-drafts/:id/approve  
POST   /api/admin/product-drafts/:id/reject  
POST   /api/admin/product-drafts/:id/merge
...
# **96\. KPI สำหรับ Product & Catalog Team**
...
* Product Detail to Project Add Rate  
* Suspended Product Rate

---

# **97\. Mobile and Tablet Rules**
...
* Review AI Draft แบบพื้นฐาน (Post-MVP)
...
## **100.3 AI PDF Import (Post-MVP Reference)**
...
* Price Sensitivity Tool  
* Supplier Data Quality Score  
* Batch Reviewer Assignment  
* Comment by Field  
...
* Automated Price Expiry Reminder
...
* Supplier Portal  
* Supplier Self-service Product Submission  
* Real-time Factory Price API  
* AI Translation  
* AI Image Enhancement  
* AI Category Classification  
* AI Option Detection  
* AI Duplicate Image Search  
* Automatic Margin Rules  
* Dynamic Member Pricing  
* Country-specific Price  
* Multi-company Catalog  
* Marketplace Moderation  
* Digital Asset Management เต็มรูปแบบ  
* Product Information Management หรือ PIM เต็มรูปแบบ  
* Approval Workflow Builder  
* Product Bundles  
* Stock and Ready-stock  
* Barcode  
* QR Sample Labels  
* AR/3D Model  
* BIM/CAD Library
...
# **104\. Acceptance Criteria Part A**
...
35. ระบบ Upload PDF Catalog ได้  
### **Post-MVP Acceptance Reference — AI Catalog Import**

36. AI Import แสดง Progress ได้  
37. AI Draft แสดง Confidence ราย Field ได้  
38. Admin เปรียบเทียบค่าที่ Extract กับ PDF ได้  
39. AI ไม่บังคับกรอกค่าที่ไม่พบ  
40. Admin เลือก Not Found หรือ Needs Confirmation ได้  
41. AI Draft ตรวจ Duplicate กับ Product Existing ได้  
42. AI Draft แปลงเป็น Product Draft ได้หลัง Review  
43. Catalog QA แสดง Product ข้อมูลไม่ครบได้  
44. Catalog QA แสดง Invalid Price ได้  
45. Catalog QA แสดง Broken Media ได้  
46. Catalog QA แสดง Duplicate Candidate ได้  
47. Product มี Audit History ได้  
48. ระบบป้องกัน Concurrent Update โดยไม่แจ้ง  
49. ทุก Form มี Loading, Error, Success และ Unsaved State  
50. Permission จำกัดต้นทุน ราคา Approval และ Publish ได้ถูกต้อง

---

# **105\. Handoff ให้ทีม UI Design**
...
17. AI Product Draft Review  
18. PDF Source Comparison  
19. Publish Review  
...
## **Sprint O: AI Catalog Import (Post-MVP เท่านั้น)**
...
7. AI เป็นผู้ช่วยดึงข้อมูล ไม่ใช่ผู้อนุมัติ  
...
เอกสารลำดับถัดไปคือ **GISP UX/UI Flow Specification Volume 3 – Part B: Operations Center** ซึ่งจะครอบคลุม Order Control Center, Supplier Order, Production, QC, Warehouse, Shipment, Delivery, Claim และการมอบหมายงานของทีมปฏิบัติการ
