...
**Change Summary:** จำกัด Assignment ไว้บน Transaction, ย้าย Generic Task Center เป็น Post-MVP และปรับ Claim State ตาม DEC-033/DEC-036  
...
* Commission, Generic Task Center และ Advanced Operations BI เป็น Post-MVP
...
**Part B ประกอบด้วยประมาณ 20 หน้าจอหลัก**
...
19. **Task Assignment Center (Post-MVP Reference)**  
...
# **24\. Task Assignment Center (Post-MVP Reference)**
...
**จัดการงานที่ต้องติดตามข้าม Module**
...
* **Task ต้องเชื่อม Entity เมื่อเกิดจาก Workflow**  
* **Completed Task ต้องมี Completed By และ Completed Date**  
* **Overdue คำนวณจาก Due Date**  
* **การ Complete Task ไม่เปลี่ยน Entity Status อัตโนมัติ เว้นแต่กำหนดไว้ใน Workflow**
...
41. **Task ต้องมี Assignee หรือ Team**  
42. **Task ต้องมี Due Date เมื่อเป็น Action Required**  
43. **Overdue Task ต้องแสดงบน Dashboard**  
...
| **Assign Task** | **Yes** | **Limited** | **Limited** | **Limited** | **Limited** | **Limited** | **Limited** | **Limited** | **Yes** |
...
**POST  /api/admin/tasks/:id/start**

**POST  /api/admin/tasks/:id/block**
