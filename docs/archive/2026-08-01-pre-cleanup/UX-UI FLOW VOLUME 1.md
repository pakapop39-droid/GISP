...
**Change Summary:** ปรับ Email Login, Account Recovery, Canonical Custom State และ Production Role ตาม DEC-032 ถึง DEC-036  
...
* Member-branded Quotation Builder, Favorite ขั้นสูง และ AI Catalog เป็น Post-MVP
* Pending/Suspended Member ต้องไม่เห็นราคาและสร้างธุรกรรมไม่ได้
* หน้าจอต้อง Responsive และไม่เปิดเผย Factory Cost/Internal Note/Confidential File
...
รวมประมาณ 40 หน้าหรือ Screen State หลัก
...
ข้อมูลที่อยู่ไม่จำเป็นต้องเก็บใน Customer ถ้าผูก Site Address ที่ Project แต่สามารถเพิ่ม Default Address ใน Should Have
...
Should Have หรือใช้เมื่อปลอดภัย

* เปลี่ยน Status  
* ย้าย Area  
* ดาวน์โหลดเฉพาะรายการ  
* เลือกพร้อมสร้าง Order

ไม่ควร Bulk Edit Options ที่แตกต่างกัน
...
* Dealer White-label Schedule  
* Quotation Builder  
* Multi-user Member Company  
* Team Permission  
* Shared Project  
* Customer Portal  
* Comment and Approval by End Customer  
* 2D Room Planning  
* Floor Plan Upload  
* Product Placement  
...
* Multi-language UI  
* Multi-country Member Pricing

---

# **71\. Acceptance Criteria Volume 1**
...
8. Member เห็นเฉพาะ Member Price  
...
21. Product Schedule ไม่แสดง Factory Cost  
...
30. ไม่มีข้อมูลต้นทุนหรือข้อมูลภายในหลุดสู่ Member UI

---

# **72\. Handoff ให้ทีม UI Design**
