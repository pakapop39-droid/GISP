...
**Document Type:** Core Administration Specification  
...
Volume 3-D เป็นเอกสาร Active สำหรับ Core MVP เท่านั้น

* User, Organization, Multi-role สำหรับทีมงาน GISP และ Permission
...
* หนึ่ง Member Profile ต่อหนึ่ง Login ไม่มี Member Team/Sub-user/Invitation ใน Core
* Price Formula Definition/Preview/Activate และ Disclosure Revoke เป็น Super Admin-only

ความสามารถ Administration ขั้นสูงแยกไว้ใน `docs/post-mvp/POST-MVP BACKLOG.md`
...
9. Backup และ Restore ต้องจำกัดสิทธิ์สูง  
10. System Log ต้องไม่เปิดเผย Password, Token หรือ Secret  
11. Action จาก Member Credential เดียว Audit เป็นบัญชีเดียวและไม่อ้างว่าสามารถแยกบุคคลจริงได้
...
Persona ในหัวข้อนี้ต้อง Map เข้ากับ Production Role ตาม DEC-035
...
เฉพาะ Super Admin จัดการ Version/Component/Inheritance ของ Price Formula, Preview/Activate/Retire
และ Revoke Supplier Disclosure Grant ได้ หน้าสูตรอยู่ใน Volume 3-A ไม่ใช่ Company Settings ทั่วไป
...
Part D ประกอบด้วย 18 หน้าจอหลัก
...
`MEMBER_ADMIN` เป็นทีมงานภายใน GISP สำหรับอนุมัติ/ระงับสมาชิก ไม่ใช่หัวหน้าทีมหรือ Sub-user ของ Member
Multi-role ใช้กับทีมงานภายใน ส่วน Member Account ไม่มี Role Assignment สำหรับสร้างทีม
...
* Member หนึ่งรายมีหนึ่ง Member Profile ต่อหนึ่ง Login  
* Core ไม่มี Member Team, Sub-user หรือ Team Invitation Screen/API  
* หาก Credential เดียวถูกใช้โดยหลายบุคคล Audit จะบันทึกเป็น User/Member Account เดียว
...
# **29\. ขอบเขตที่นำออกจาก Core MVP**

รายการ Administration ขั้นสูงถูกแยกไว้ที่ `docs/post-mvp/POST-MVP BACKLOG.md`
...
32. ไม่มี Member Team/Sub-user/Invitation UI หรือ Permission ใน Core  
33. `MEMBER_ADMIN` ถูกอธิบายเป็น GISP Internal Role ทุกจุด  
34. เฉพาะ Super Admin เข้าถึง Price Formula Definition/Preview/Activate ได้  
35. Super Admin Revoke Supplier Disclosure พร้อมเหตุผลและ Audit ได้

# **31\. Codex Development Scope**
...
## **31.1 Workstream D4: System Logs**

* Security Log
* Background Job/Error Log
* Notification Delivery Log
* Filter, Retention และ Audit ตามสิทธิ์
