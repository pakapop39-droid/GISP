...
* Claim ใช้ Warranty Snapshot และแยก Responsibility เป็น Supplier, Logistics/Insurance หรือ Installer
* ระบบเสนอ Responsibility ได้ แต่ `ORDER_ADMIN` ต้องยืนยันและไม่มี Automatic Compensation
...
* **Product/Item**  
* **Claim Type**  
* **Suggested/Confirmed Responsibility**  
* **Severity**  
* **Submitted Date**  
* **Current Status**  
* **Assigned Owner**  
...
* **Confirmed Responsibility/Confirmed By**  
* **Supplier Order**  
...
* **Manufacturing/Material/Specification แนะนำ `SUPPLIER`**  
* **Transit Damage แนะนำ `LOGISTICS_INSURANCE`**  
* **Installation แนะนำ `INSTALLER`**  
* **`ORDER_ADMIN` ต้องยืนยัน Responsibility ก่อนประสาน Resolution**  
* **Partner Warranty ใช้ Snapshot จาก Order Item และห้ามแก้ย้อนหลัง**  
* **Member Timeline/Response ปกปิดชื่อ Supplier จน Member มี Active Disclosure Grant**  
* **GISP ประสานงานตามเงื่อนไขต้นทางและไม่อนุมัติ Compensation/Warranty อัตโนมัติ**
...
41. **Claim ต้องอ้าง Warranty Snapshot ของ Order Item**  
42. **ระบบเสนอ Responsibility ได้แต่ Order Admin ต้องยืนยัน**  
43. **Member Response ต้อง Redact Supplier Identity หากไม่มี Disclosure Grant**
...
| **Confirm Claim Responsibility** | **Yes** | **Support** | **View** | **View** | **View** | **Support** | **Support** | **No** | **Yes** |
...
46. **Order Item Warranty Snapshot แสดงใน Claim Detail โดยไม่เปลี่ยนตาม Master ใหม่**  
47. **Issue Type เสนอ Supplier/Logistics-Insurance/Installer และ Order Admin ยืนยันได้**  
48. **Member-visible Claim ไม่แสดงชื่อโรงงานเมื่อไม่มี Active Disclosure Grant**  
49. **ระบบไม่คำนวณค่าชดเชยหรืออนุมัติ Warranty อัตโนมัติ**
