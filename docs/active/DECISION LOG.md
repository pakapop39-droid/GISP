...
| DEC-069 | อนุมัติ Scope + Implementation ของ `PDF Catalog Excel Round-trip v1.0` บน Development | เพิ่ม Export `.xlsx` จาก PDF Import, อัปโหลดกลับเพื่อ Preview/Diff และแยกยืนยันรายละเอียดกับ Factory Cost; ใช้ additive schema/RLS/trusted RPC, Confidential Storage, `fflate@0.8.3`, test data/Product Draft/Cost Version เท่านั้น; Feature Flag เริ่มปิด; ไม่เปลี่ยน Excel/CSV create-new และไม่ Activate Member Price; Production=No | Approved by ภคภพ ช.เจริญยิ่ง — 13 September 2026 12:08:36 +07:00 |
