...
- `npx vitest run src/components/catalog-import-workspace.test.ts src/components/pdf-catalog-review.test.ts` — 2 files / 7 behavioral, API contract and component tests passed after the live History navigation UX rework.
- `npm test` — 52 files / 244 tests passed after QA rework.
