-- Slice 11: close the Material Sample / Built-in Display and Partner Warranty
-- gaps. Member-facing data is projected through one safe RPC; operational
-- tables remain internal and warranty snapshots become immutable at Order time.
