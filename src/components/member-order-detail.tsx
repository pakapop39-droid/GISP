...
export function MemberOrderDetail({ orderId, showProductionQc = true, showLogistics = true }: { orderId: string; showProductionQc?: boolean; showLogistics?: boolean }) {
  ...
  return <main className="order-detail">
    ...
    {showProductionQc ? <MemberProductionQcPanel data={data} busy={busy} post={post}/> : null}
    {showLogistics ? <MemberLogisticsPanel data={data} busy={busy} post={post}/> : null}
